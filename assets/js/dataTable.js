...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const dbRef = database.ref('Users'); // Replace with your database path
...
// مرجع العقدة الرئيسية "Users"
const usersRef = database.ref('Users');

// البحث عن مستخدم باستخدام الاسم
    ...
    usersRef.orderByChild('Name').equalTo(name).once('value', (snapshot) => {
        if (snapshot.exists()) {
            ...
            snapshot.forEach((childSnapshot) => {
                ...
                // يمكنك هنا استخدام البيانات كما تحتاج
            });
        } else {
...
// مثال على البحث عن مستخدم بالاسم
getUserByName("Khalid");
