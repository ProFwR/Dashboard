import { chartData, readCardData } from './data.js';
...
// Example function to display data
function displayCardData() {
  readCardData()
    .then((values) => {
      console.log(values);
      document.getElementById("revenue").innerHTML  = values[0].Revenue;
      document.getElementById("students").innerHTML = values[0].Students;
      document.getElementById("teachers").innerHTML = values[0].Teachers;
    })
    .catch((error) => {
